        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                @auth
                    ...
                    <li class="nav-item"><a onclick="logout.submit()" class="nav-link px-lg-3 py-3 py-lg-4" href="#">Выход</a></li>
                @else
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/login">Вход</a></li>
